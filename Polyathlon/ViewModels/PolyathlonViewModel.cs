...
public partial class PolyathlonViewModel : DocumentsViewModel<PolyathlonModuleDescription, IDbUnitOfWork>
{
    ...
    protected override List<PolyathlonModuleDescription> CreateModules()
    {
        string moduleContent = @"{'total_rows':4,'offset':0,'rows':[
                ...
                { 'id':'module:8997d7edcad3eae911a0c9abb100097a','key':'module:8997d7edcad3eae911a0c9abb100097a','value':{ 'rev':'1-52dc66bc4a76166e8348d4b76e2b4b78'},'doc':{ '_id':'module:8997d7edcad3eae911a0c9abb100097a','_rev':'1-52dc66bc4a76166e8348d4b76e2b4b78','moduleTitle':'Регионы','moduleGroup':'Operation','documentType':'RegionCollectionView', 'tileColor':'255,0,255', 'tileFontSize':'12', 'tileTitle':'Регионы', 'requests': [{'url':'https://localhost:5984/polyathlon/region?include_docs=true'}, {'url':'https://localhost:5984/polyathlon/clubs?include_docs=true'}]}}
            ]}";
