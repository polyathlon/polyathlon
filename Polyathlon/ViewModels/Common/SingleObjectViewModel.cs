...
namespace Polyathlon.ViewModels.Common
{
    ...
    /// <typeparam name="TUnitOfWork">A unit of work type.</typeparam>
    [POCOViewModel]
    public abstract class SingleObjectViewModelBase<TEntity, TViewEntity, TPrimaryKey> : ISingleObjectViewModel<TEntity, TViewEntity, TPrimaryKey>, ISupportParameter, IDocumentContent, ISupportLogicalLayout<TPrimaryKey>
        where TViewEntity : class, new()
    {
