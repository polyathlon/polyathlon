...
{
    [ViewType("BallTableKindView")]
    public partial class BallTableKindView : BaseViewWithWinUIButtons
    {
        public BallTableKindView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<BallTableKindViewModel>();
            fluentAPI.SetObjectDataSourceBinding(ballTableKindBindingSource, x => x.ViewEntity, x => x.Update());
