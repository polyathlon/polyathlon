...
{
    [ViewType("SportsmenView")]
    public partial class SportsmenView : BaseViewWithWinUIButtons
    {
        ...
        {
            var fluentAPI = mvvmContext.OfType<SportsmenViewModel>();
            fluentAPI.SetObjectDataSourceBinding(sportsmenBindingSource, x => x.ViewEntity, x => x.Update());
