...
{
    [ViewType("AgeGroupView")]
    public partial class AgeGroupView : BaseViewWithWinUIButtons
    {
        public AgeGroupView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<AgeGroupViewModel>();
            fluentAPI.SetObjectDataSourceBinding(ageGroupBindingSource, x => x.ViewEntity, x => x.Update());
