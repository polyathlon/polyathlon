...
{
    [ViewType("ExerciseNameView")]
    public partial class ExerciseNameView : BaseViewWithWinUIButtons
    {
        public ExerciseNameView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<ExerciseNameViewModel>();
            fluentAPI.SetObjectDataSourceBinding(exerciseNameBindingSource, x => x.ViewEntity, x => x.Update());
