...
{
    [ViewType("ExerciseView")]
    public partial class ExerciseView : BaseViewWithWinUIButtons
    {
        public ExerciseView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<ExerciseViewModel>();
            fluentAPI.SetObjectDataSourceBinding(exerciseBindingSource, x => x.ViewEntity, x => x.Update());
