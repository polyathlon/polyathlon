...
{
    [ViewType("ExerciseCollectionView")]
    public partial class ExerciseCollectionView : BaseViewWithWinUIButtons, ISupportParameter
    {
        public object Parameter { get; set; }

        public ExerciseCollectionView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<ExerciseCollectionViewModel>();
            mvvmContext.BindCollectionGrid<ExerciseCollectionViewModel, ExerciseViewEntity, Exercise>(gridView, exerciseBindingSource);

            fluentAPI.SetObjectDataSourceBinding(exerciseBindingSource, x => x.Entities);
            fluentAPI.SetBinding(exerciseBindingSource, rbs => rbs.DataSource, x => x.Entities);
