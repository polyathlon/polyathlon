...
{
    [ViewType("AgeCoefficientView")]
    public partial class AgeCoefficientView : BaseViewWithWinUIButtons
    {
        public AgeCoefficientView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<AgeCoefficientViewModel>();
            fluentAPI.SetObjectDataSourceBinding(ageCoefficientBindingSource, x => x.ViewEntity, x => x.Update());
