...
{
    [ViewType("RefereeCategoryView")]
    public partial class RefereeCategoryView : BaseViewWithWinUIButtons
    {
        public RefereeCategoryView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<RefereeCategoryViewModel>();
            fluentAPI.SetObjectDataSourceBinding(refereeCategoryBindingSource, x => x.ViewEntity, x => x.Update());
