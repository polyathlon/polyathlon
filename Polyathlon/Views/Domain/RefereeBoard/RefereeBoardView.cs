...
{
    [ViewType("RefereeBoardView")]
    public partial class RefereeBoardView : BaseViewWithWinUIButtons
    {
        public RefereeBoardView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<RefereeBoardViewModel>();
            fluentAPI.SetObjectDataSourceBinding(refereeBoardBindingSource, x => x.ViewEntity, x => x.Update());
