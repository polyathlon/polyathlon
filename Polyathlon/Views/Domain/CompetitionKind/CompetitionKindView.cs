...
{
    [ViewType("CompetitionKindView")]
    public partial class CompetitionKindView : BaseViewWithWinUIButtons
    {
        public CompetitionKindView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<CompetitionKindViewModel>();
            fluentAPI.SetObjectDataSourceBinding(competitionKindBindingSource, x => x.ViewEntity, x => x.Update());
