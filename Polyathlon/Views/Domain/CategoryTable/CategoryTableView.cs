...
{
    [ViewType("CategoryTableView")]
    public partial class CategoryTableView : BaseViewWithWinUIButtons
    {
        ...
        {
            var fluentAPI = mvvmContext.OfType<CategoryTableViewModel>();
            fluentAPI.SetObjectDataSourceBinding(categoryTableBindingSource, x => x.ViewEntity, x => x.Update());
