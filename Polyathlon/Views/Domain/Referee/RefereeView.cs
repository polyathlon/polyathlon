...
{
    [ViewType("RefereeView")]
    public partial class RefereeView : BaseViewWithWinUIButtons
    {
        public RefereeView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<RefereeViewModel>();
            fluentAPI.SetObjectDataSourceBinding(refereeBindingSource, x => x.ViewEntity, x => x.Update());
