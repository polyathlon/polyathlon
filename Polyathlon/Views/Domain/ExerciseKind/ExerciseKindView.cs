...
{
    [ViewType("ExerciseKindView")]
    public partial class ExerciseKindView : BaseViewWithWinUIButtons
    {
        public ExerciseKindView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<ExerciseKindViewModel>();
            fluentAPI.SetObjectDataSourceBinding(exerciseKindBindingSource, x => x.ViewEntity, x => x.Update());
