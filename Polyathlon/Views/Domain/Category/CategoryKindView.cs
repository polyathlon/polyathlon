...
namespace Polyathlon.Views
{
    ...
    public partial class CategoryView : BaseViewWithWinUIButtons
    {
        public CategoryView()
        {
            InitializeComponent();
        ...
        {
            var fluentAPI = mvvmContext.OfType<CategoryViewModel>();
            fluentAPI.SetObjectDataSourceBinding(categoryBindingSource, x => x.ViewEntity, x => x.Update());
