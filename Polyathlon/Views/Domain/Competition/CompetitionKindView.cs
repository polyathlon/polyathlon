...
{
    [ViewType("CompetitionView")]
    public partial class CompetitionView : BaseViewWithWinUIButtons
    {
        ...
        {
            var fluentAPI = mvvmContext.OfType<CompetitionViewModel>();
            fluentAPI.SetObjectDataSourceBinding(competitionBindingSource, x => x.ViewEntity, x => x.Update());
