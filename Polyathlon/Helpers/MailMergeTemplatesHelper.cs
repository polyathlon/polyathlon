...
namespace Polyathlon.Helpers
{
    ...
    {
        private static string[] templateNames = new string[] { "Employee of the Month.snx", "Employee Probation Notice.snx", "Employee Service Excellence.snx", "Employee Thank You Note.snx", "Welcome to DevAV.snx" };
